...
describe('App', () => {
  ...
  it('renders the Remotion action library subpage', () => {
    ...
    expect(screen.getByRole('heading', { level: 2, name: /实时 Demo/ })).toBeInTheDocument()
    ...
    expect(screen.getByText(/2 种资产类型/)).toBeInTheDocument()
    expect(screen.getByRole('button', { name: /PPT 局部聚焦/ })).toBeInTheDocument()
  })
})
